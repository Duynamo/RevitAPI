...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._cbb_FloorPlane = System.Windows.Forms.ComboBox()
		...
		self._grb_CadFolder.Controls.Add(self._cbb_FloorPlane)
		...
		# cbb_FloorPlane
		# 
		self._cbb_FloorPlane.DisplayMember = "Name"
		self._cbb_FloorPlane.FormattingEnabled = True
		self._cbb_FloorPlane.Location = System.Drawing.Point(108, 104)
		self._cbb_FloorPlane.Name = "cbb_FloorPlane"
		self._cbb_FloorPlane.Size = System.Drawing.Size(294, 27)
		self._cbb_FloorPlane.TabIndex = 3
		self._cbb_FloorPlane.Items.AddRange(System.Array[System.Object](levelsCollector))
		self._cbb_FloorPlane.SelectedIndex = 0		
		# 
		# lb_Level
		# 
	...
	def Btt_BrowserClick(self, sender, e):
		...
		fileDialog.Filter = "CAD Files (*.dwg)|*.dwg|All Files (*.*)|*.*"
		if fileDialog.ShowDialog() == DialogResult.OK:
			selected_file = fileDialog.FileName
			self._txb_link.Text = selected_file
		pass
	...
	def Btt_OKClick(self, sender, e):
		...
		dwgImportOptions.Unit = ImportUnit.Millimeter
		desCadFilePath = self._txb_link.selected_file
		# Start a transaction to import the CAD file
		TransactionManager.Instance.EnsureInTransaction(doc)
		import_instance = ImportInstance.Create(doc, desCadFilePath, dwgImportOptions)

		view = self._cbb_FloorPlane.SelectedItem
		viewId = view.Id
		
		view_origin = view.Origin
		import_instance.SetPosition(XYZ.Zero, view_origin)
