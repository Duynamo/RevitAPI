...
for item in eleList:
    elementLengthCheck = item.LookupParameter("L")
    if elementLengthCheck is not None:
        elementLength = elementLengthCheck.AsDouble()
        element_FVC_Length = item.LookupParameter("FVC_Length")
        TransactionManager.Instance.EnsureInTransaction(doc)
        element_FVC_Length.Set(elementLength)
