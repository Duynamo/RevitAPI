...
TransactionManager.Instance.EnsureInTransaction(doc)
_elbowConns = list(elbow.MEPModel.ConnectorManager.Connectors)
_elbowConnsOrigin = [c.Origin for c in _elbowConns]
_baseElbowConns = list(baseElbow.MEPModel.ConnectorManager.Connectors)
_baseElbowConnsOrigin = [c.Origin for c in _baseElbowConns]
_tempPlane = planeFrom3Points(_elbowConnsOrigin[0], _baseElbowConnsOrigin[1], _baseElbowConnsOrigin[0])
if _tempPlane is not None:
	tempPlane = _tempPlane
else:
	tempPlane = planeFrom3Points(_elbowConnsOrigin[1], _baseElbowConnsOrigin[1], _baseElbowConnsOrigin[0])
