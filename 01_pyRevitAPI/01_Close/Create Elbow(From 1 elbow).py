...
TransactionManager.Instance.EnsureInTransaction(doc)
_tempPlane1 = planeFrom3Points(unConnectedConnOfBaseElbow.Origin, connectedConnOfBaseElbow.Origin, endPoint1)
tempSketchPlane1 = SketchPlane.Create(doc, _tempPlane1)
...
_tempPlane2 = planeFrom3Points(unConnectedConnOfBaseElbow.Origin, connectedConnOfBaseElbow.Origin, endPoint2)
tempSketchPlane2 = SketchPlane.Create(doc, _tempPlane2)
doc.ActiveView.SketchPlane = tempSketchPlane2
TransactionManager.Instance.EnsureInTransaction(doc)
pipes = []
...
doc.Delete(tempSketchPlane2.Id)
TransactionManager.Instance.TransactionTaskDone()
#endregion
